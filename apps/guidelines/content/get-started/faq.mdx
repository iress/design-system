...
v5 remains maintained for security fixes, but new features and components are only added to v6. We recommend planning your migration. See the [v5 to v6 migration guide](/resources-migration-guides/from-v5-to-v6).

## What support is available for migration?

A comprehensive [migration guide](/resources-migration-guides/from-v5-to-v6) covers all breaking changes. If you plan to migrate soon, reach out to the design system team — we partner with teams during migration.
