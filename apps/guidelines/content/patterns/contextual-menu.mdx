...
```tsx
import { IressContextualMenu, IressStack } from '@iress-oss/ids-components';
...
```tsx
import { IressContextualMenu, IressInline, IressStack, IressStyled } from '@iress-oss/ids-components';
...
```tsx
import { IressContextualMenu, IressInline } from '@iress-oss/ids-components';
