...
```tsx
<IressForm heading="Required example" pattern="short">
<IressFormField
  name="name"
  label="Name"
...
```tsx
<IressForm heading="Max length example" pattern="short">
<IressFormField
  name="username"
  label="Username"
  rules={{ maxLength: { value: 20, message: 'Max 20 characters' } }}
  render={(controlledProps) => <IressInput {...controlledProps} maxLength={20} />}
/>
<IressButton type="submit" mode="primary">Submit</IressButton>
</IressForm>
```
...
```tsx
<IressForm heading="Min length example" pattern="short">
<IressFormField
  name="password"
  label="Password"
...
```tsx
<IressForm heading="Max example" pattern="short">
<IressFormField
  name="quantity"
  label="Quantity"
  rules={{ max: { value: 100, message: 'Max value is 100' } }}
...
```tsx
<IressForm heading="Min example" pattern="short">
<IressFormField
  name="age"
  label="Age"
  rules={{ min: { value: 18, message: 'Must be at least 18' } }}
  render={(controlledProps) => <IressInput {...controlledProps} type="number" />}
/>
<IressButton type="submit" mode="primary">Submit</IressButton>
</IressForm>
...
```tsx
<IressForm heading="Min date example" pattern="short">
<IressFormField
  name="startDate"
  label="Start date"
...
```tsx
<IressForm heading="Max date example" pattern="short">
<IressFormField
  name="endDate"
  label="End date"
...
```tsx
<IressForm heading="Email example" pattern="short">
<IressFormField
  name="email"
  label="Email"
...
```tsx
<IressForm heading="Validate example" pattern="short">
<IressFormField
  name="interests"
  label="Interests"
  ...
  render={(controlledProps) => (
    <IressCheckboxGroup {...controlledProps}>
      ...
      <IressCheckbox value="travel">Travel</IressCheckbox>
    </IressCheckboxGroup>
  )}
/>
<IressButton type="submit" mode="primary">Submit</IressButton>
