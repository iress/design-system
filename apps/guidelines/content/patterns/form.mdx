import { formMeta } from '@iress-oss/ids-components/meta';
...
- [Field](/components/field) — for standalone field layout without form validation
- [FormField](/patterns/form-field) — for individual validated form fields
- [Input](/components/input) — for text input controls
- [Select](/components/select) — for single-value selection
- [Checkbox](/components/checkbox) — for boolean or multi-select options
...
<IressButton mode="secondary" href="https://main--691abcc79dfa560a36d0a74f.chromatic.com/?path=/docs/patterns-form--docs#api-props">View all props</IressButton>
...
<IressButton mode="secondary" href="https://main--691abcc79dfa560a36d0a74f.chromatic.com/?path=/docs/patterns-form--docs#testing">View test roles/IDs</IressButton>
...
<IressButton mode="secondary" href="https://main--691abcc79dfa560a36d0a74f.chromatic.com/?path=/docs/patterns-form--docs">View in Storybook</IressButton>
