import { dropdownMenuMeta } from '@iress-oss/ids-components/meta';
...
<Metadata meta={dropdownMenuMeta} />
...
- [ContextualMenu](/patterns/contextual-menu) — for action menus on specific items
...
<IressButton mode="secondary" href="https://main--691abcc79dfa560a36d0a74f.chromatic.com/?path=/docs/patterns-dropdown-menu--docs#api-props">View all props</IressButton>
...
<IressButton mode="secondary" href="https://main--691abcc79dfa560a36d0a74f.chromatic.com/?path=/docs/patterns-dropdown-menu--docs">View in Storybook →</IressButton>
