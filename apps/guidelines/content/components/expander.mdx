export const meta = {
  ...
  storybookUrl: 'https://main--691abcc79dfa560a36d0a74f.chromatic.com/?path=/docs/components_components-expander--docs',
};
...
```tsx
import { IressExpander, IressStack, IressText } from '@iress-oss/ids-components';

<IressStack gap="lg">
  <IressStack gap="xs">
    <IressText element="h2">Section (default)</IressText>
    <IressExpander mode="section" activator="View details">
      This is the expanded content for the section mode.
    </IressExpander>
  </IressStack>
  <IressStack gap="xs">
    <IressText element="h2">Link</IressText>
    <IressExpander mode="link" activator="Learn more">
      This is the expanded content for the link mode.
    </IressExpander>
  </IressStack>
</IressStack>
```
...
<IressExpander open activator="Expander activator">
  This expander is open by default.
</IressExpander>
```
