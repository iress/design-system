...
- **Call to action at the start/end of content** — use [Button](/components/button) instead
- **Primary form actions** (submit, save) — use [Button](/components/button) instead
- **Navigation menus** — use dedicated navigation patterns like [SideNav](/patterns/side-nav)
...
- [Button](/components/button) — for primary actions and calls to action
- [Breadcrumbs](/patterns/breadcrumbs) — for navigation hierarchy
- [SideNav](/patterns/side-nav) — for application navigation menus
...
<IressButton mode="secondary" href="https://main--691abcc79dfa560a36d0a74f.chromatic.com/?path=/docs/components-link--docs#api-props">View all props</IressButton>
...
<IressButton mode="secondary" href="https://main--691abcc79dfa560a36d0a74f.chromatic.com/?path=/docs/components-link--docs">View in Storybook</IressButton>
