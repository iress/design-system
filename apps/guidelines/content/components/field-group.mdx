...
<StoryEmbed id="components-field-fieldgroup--inline"/>
...
<IressButton mode="secondary" href="https://main--691abcc79dfa560a36d0a74f.chromatic.com/?path=/docs/components-field-fieldgroup--docs#api-props">View all props</IressButton>
...
<StoryEmbed id="components-field-fieldgroup--inline-sink"/>

#### Joined

Visually connected fields that form a single value.

<StoryEmbed id="components-field-fieldgroup--join"/>

#### Joined with sink

Joined fields with error sink behaviour.

<StoryEmbed id="components-field-fieldgroup--join-sink"/>
...
<IressButton mode="secondary" href="https://main--691abcc79dfa560a36d0a74f.chromatic.com/?path=/docs/components-field-fieldgroup--docs#testing">View test IDs</IressButton>
