...
<IressRadioGroup name="survey">
  <IressRadio value="option-a">Option A</IressRadio>
  <IressRadio value="option-b">Option B</IressRadio>
</IressRadioGroup>
```
...
<IressRadioGroup defaultValue="newspaper">
  ...
  <IressRadio value="online">Online</IressRadio>
</IressRadioGroup>
```
...
>
<IressRadioGroup>
  <IressRadio value="investments">Investments</IressRadio>
  <IressRadio value="retirement">Retirement</IressRadio>
</IressRadioGroup>
</IressField>
```
...
```tsx
<IressRadioGroup readOnly value="option-a">
  <IressRadio value="option-a">Option A</IressRadio>
  <IressRadio value="option-b">Option B</IressRadio>
</IressRadioGroup>
```
