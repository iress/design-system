...
```tsx
<IressPopover
  activator={<IressButton>Open wide popover</IressButton>}
...
```tsx
<IressInputPopover activator={<IressInput placeholder="Type to search..." />}>
