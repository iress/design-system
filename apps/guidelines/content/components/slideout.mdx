...
```tsx
import { IressButton, IressInline, IressPanel, IressSlideout, IressText } from '@iress-oss/ids-components';
    ...
    return (
      <IressPanel bg="alt">
        <IressInline gap="md">
          ...
          <IressSlideout id="overlay" mode="overlay">
            <h2>Overlay</h2>
...
```tsx
import { IressSlideoutProvider } from '@iress-oss/ids-components';
