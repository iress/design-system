...
<IressField label="Email address" errorMessages={[{ message: 'Email is required' }]} />
```
...
<IressField label="Email address" error={<span>Please enter a valid email</span>} />
```
...
<IressFieldGroup inline label="Inline fields">
  {/* Field children */}
</IressFieldGroup>
```
...
<IressFieldGroup join label="Joined fields">
  {/* Field children */}
</IressFieldGroup>
```
