...
```tsx
import { IressInline, IressStack, IressText } from '@iress-oss/ids-components';
...
```tsx
import { IressInline, IressStack } from '@iress-oss/ids-components';

<IressStack gap="spacing.4">
  <IressInline gap={{ xs: "spacing.2", md: "spacing.4", lg: "spacing.8" }}>
    <span>Item 1</span>
    <span>Item 2</span>
    <span>Item 3</span>
  </IressInline>
...
```tsx
import { IressInline, IressStack, IressContainer, IressText } from '@iress-oss/ids-components';
...
<IressContainer>
  <IressStack gap="spacing.10">
    ...
    <IressText>
      <h2>center</h2>
      <IressInline horizontalAlign="center">
        <span>Item 1</span>
        <span>Item 2</span>
        <span>Item 3</span>
      </IressInline>
...
<IressContainer>
  <IressStack gap="spacing.10">
    <IressText textAlign="center">
      <h2>top</h2>
      <IressInline verticalAlign="top">
        <span style={{ height: '3rem' }}>Tall</span>
        <span>Short</span>
      </IressInline>
    </IressText>
    <IressText textAlign="center">
    ...
    <IressText textAlign="center">
      <h2>bottom</h2>
      <IressInline verticalAlign="bottom">
        <span style={{ height: '3rem' }}>Tall</span>
        <span>Short</span>
      </IressInline>
    </IressText>
    <IressText textAlign="center">
      <h2>stretch</h2>
      <IressInline verticalAlign="stretch">
        <span style={{ height: '3rem' }}>Tall</span>
        <span>Short</span>
      </IressInline>
    </IressText>
