...
- **Grid columns** — use [Row](/components/row) + [Col](/components/col) for proportional grid layouts
- **Vertical spacing** — use [Stack](/components/stack) instead

### Related patterns

- [Stack](/components/stack) — vertical equivalent
...
<IressButton mode="secondary" href="https://main--691abcc79dfa560a36d0a74f.chromatic.com/?path=/docs/components-inline--docs#api-props">View all props</IressButton>
...
<IressButton mode="secondary" href="https://main--691abcc79dfa560a36d0a74f.chromatic.com/?path=/docs/components-inline--docs">View in Storybook</IressButton>
