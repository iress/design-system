...
<IressCheckboxGroup name="let-them-eat-cake">
  <IressCheckbox value="chocolate">Chocolate</IressCheckbox>
  <IressCheckbox value="vanilla">Vanilla</IressCheckbox>
  <IressCheckbox value="strawberry">Strawberry</IressCheckbox>
</IressCheckboxGroup>
```
...
```tsx
<IressCheckboxGroup readOnly value={["option-1"]}>
  <IressCheckbox value="option-1">Option 1</IressCheckbox>
  <IressCheckbox value="option-2">Option 2</IressCheckbox>
</IressCheckboxGroup>
```
...
<IressCheckboxGroup variant="touch">
  <IressCheckbox value="option-1">Option 1</IressCheckbox>
  <IressCheckbox value="option-2">Option 2</IressCheckbox>
  <IressCheckbox value="option-3">Option 3</IressCheckbox>
</IressCheckboxGroup>
```
