...
<StoryEmbed id="components-checkbox-group--checkbox-children"/>
...
<StoryEmbed id="components-checkbox-group--default-checked"/>
...
<StoryEmbed id="components-checkbox-group--controlled"/>
...
<StoryEmbed id="components-checkbox-group--layout"/>
...
<StoryEmbed id="components-checkbox-group--hidden-checkboxes"/>
...
<StoryEmbed id="components-checkbox-group--custom-checkbox-group-layout"/>
...
<StoryEmbed id="components-checkbox-group--read-only"/>

### Touch

The `touch` prop adds the button-like border and padding to checkbox.

<StoryEmbed id="components-checkbox-group--touch"/>
