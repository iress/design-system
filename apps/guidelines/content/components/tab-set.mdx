...
```tsx
import { IressPanel, IressStack, IressTabSet, IressText } from '@iress-oss/ids-components';
...
```tsx
import { IressExpander, IressPanel, IressStack, IressTabSet, IressText } from '@iress-oss/ids-components';
