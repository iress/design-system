...
```tsx
<IressMenu defaultSelected={5} role="listbox">
  <IressMenuItem value={1}>Item 1</IressMenuItem>
  <IressMenuItem value={5}>Item 5</IressMenuItem>
  <IressMenuItem value={10}>Item 10</IressMenuItem>
</IressMenu>
```
...
<IressMenu maxWidth="3/12">
  ...
  <IressMenuItem prepend={<IressIcon name="edit" />} divider>Edit</IressMenuItem>
  <IressMenuItem prepend={<IressIcon name="delete" />}>Delete</IressMenuItem>
</IressMenu>
```
...
<IressMenu role="list">
  <IressMenuItem href="/dashboard">Dashboard</IressMenuItem>
...
```tsx
<IressMenu>
  <IressMenuHeading>Section 1</IressMenuHeading>
  <IressMenuItem>Item 1</IressMenuItem>
  <IressMenuHeading>Section 2</IressMenuHeading>
  <IressMenuItem>Item 2</IressMenuItem>
</IressMenu>
```
...
```tsx
<IressMenu>
  <IressMenuItem divider>Item with divider</IressMenuItem>
  <IressMenuItem>Item without divider</IressMenuItem>
  <IressMenuDivider />
  <IressMenuItem>Item after divider</IressMenuItem>
</IressMenu>
```
...
```tsx
<IressMenu role="menu">
  <IressMenuItem prepend={<IressIcon name="home" />}>Home</IressMenuItem>
  <IressMenuItem append={<IressPill>3</IressPill>}>Notifications</IressMenuItem>
</IressMenu>
```
...
```tsx
<IressMenu role="listbox" defaultSelected="option-1">
  <IressMenuItem value="option-1">Option 1</IressMenuItem>
  <IressMenuItem value="option-2">Option 2</IressMenuItem>
</IressMenu>
```
...
```tsx
<IressStack gap="lg">
<IressMenu variant="radio" role="listbox" defaultSelected="item-1">
  <IressMenuItem value="item-1">Item 1</IressMenuItem>
  <IressMenuItem value="item-2">Item 2</IressMenuItem>
</IressMenu>
<IressMenu variant="subdraw" maxWidth="input.12">
  <IressMenuItem>Navigation item</IressMenuItem>
  <IressMenuItem>Another item</IressMenuItem>
</IressMenu>
<IressMenu variant="side" maxWidth="input.12">
  <IressMenuItem>Side item 1</IressMenuItem>
  <IressMenuItem>Side item 2</IressMenuItem>
</IressMenu>
<IressMenu variant="side" maxWidth="input.12" numbered>
  <IressMenuItem>Step 1</IressMenuItem>
  <IressMenuItem>Step 2</IressMenuItem>
</IressMenu>
<IressMenu variant="rail">
  <IressMenuItem icon="home">Home</IressMenuItem>
  <IressMenuItem icon="settings">Settings</IressMenuItem>
</IressMenu>
</IressStack>
```
