import { toasterMeta } from '@iress-oss/ids-components/meta';
...
- **Persistent contextual messages** that relate to page content — use [Alert](/components/alert) instead
- **Critical information or decisions** the user must acknowledge — use [Modal](/components/modal) instead
...
- [Alert](/components/alert) — for persistent inline messages
...
<IressButton mode="secondary" href="https://main--691abcc79dfa560a36d0a74f.chromatic.com/?path=/docs/components-toaster--docs#api-props">View all props</IressButton>
...
<IressButton mode="secondary" href="https://main--691abcc79dfa560a36d0a74f.chromatic.com/?path=/docs/components-toaster--docs">View in Storybook</IressButton>
