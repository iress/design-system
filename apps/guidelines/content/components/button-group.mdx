...
```tsx
import { IressButtonGroup, IressButton, useToaster } from '@iress-oss/ids-components';
...
return (
  ...
  >
    <IressButton value="left">Left</IressButton>
    <IressButton value="center">Center</IressButton>
    <IressButton value="right">Right</IressButton>
  </IressButtonGroup>
);
```
