...
<IressButtonGroup label="Text alignment">
  <IressButton value="left" icon="format_align_left">Left</IressButton>
  <IressButton value="center" icon="format_align_center">Center</IressButton>
  <IressButton value="right" icon="format_align_right">Right</IressButton>
</IressButtonGroup>
```
...
```tsx
<IressButtonGroup multiple defaultSelected={["Option 1", "Option 3"]} label="Selected option for multi-select">
  <IressButton>Option 1</IressButton>
  <IressButton>Option 2</IressButton>
  <IressButton>Option 3</IressButton>
</IressButtonGroup>
...
```tsx
<IressButtonGroup hiddenLabel label="Options">
  <IressButton>Option 1</IressButton>
  <IressButton>Option 2</IressButton>
  <IressButton>Option 3</IressButton>
</IressButtonGroup>
