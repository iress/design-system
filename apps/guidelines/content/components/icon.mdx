import { iconMeta } from '@iress-oss/ids-components/meta';
...
- **Decorative imagery** — use [Image](/components/image) for illustrations or photos
...
- [Image](/components/image) — for photos, illustrations, and larger visual content
- [Button](/components/button) — icon buttons with labels for accessible actions
- [Spinner](/components/spinner) — for animated loading indicators
...
<IressButton mode="secondary" href="https://main--691abcc79dfa560a36d0a74f.chromatic.com/?path=/docs/components-icon--docs#api-props">View all props</IressButton>
...
<IressButton mode="secondary" href="https://main--691abcc79dfa560a36d0a74f.chromatic.com/?path=/docs/components-icon--docs">View in Storybook</IressButton>
