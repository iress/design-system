...
<StoryEmbed id="components-icon--material-symbols"/>
...
<StoryEmbed id="components-provider--icon-provider"/>
...
<StoryEmbed id="components-icon--font-awesome"/>
...
<StoryEmbed id="components-icon--reference"/>
