...
- **Simple horizontal spacing** — use [Inline](/components/inline) instead
- **Without a Row** — `IressCol` must be a direct child of `IressRow`

### Related patterns

- [Row](/components/row) — parent container for columns
- [Container](/components/container) — centres and pads page content
- [Inline](/components/inline) — simpler horizontal layout without grid semantics
...
<IressButton mode="secondary" href="https://main--691abcc79dfa560a36d0a74f.chromatic.com/?path=/docs/components-col--docs#api-props">View all props</IressButton>
...
<IressButton mode="secondary" href="https://main--691abcc79dfa560a36d0a74f.chromatic.com/?path=/docs/components-col--docs">View in Storybook</IressButton>
