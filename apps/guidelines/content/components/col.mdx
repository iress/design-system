...
```tsx
import { IressCol, IressRow, IressStack, IressPlaceholder } from '@iress-oss/ids-components';
...
```tsx
import { IressCol, IressRow, IressStack, IressPlaceholder, IressText } from '@iress-oss/ids-components';
    ...
    <IressCol span={{ xs: "12", md: "6", lg: "4" }}>
      <IressPlaceholder>
        <IressText textAlign="center">
          Column 1
          <br />
          {JSON.stringify({ xs: "12", md: "6", lg: "4" })}
        </IressText>
      </IressPlaceholder>
    </IressCol>
    <IressCol span={{ xs: "12", md: "6", lg: "4" }}>
    ...
    <IressCol span={{ xs: "12", md: "12", lg: "4" }}>
      <IressPlaceholder>
        <IressText textAlign="center">
          Column 3
          <br />
          {JSON.stringify({ xs: "12", md: "12", lg: "4" })}
        </IressText>
      </IressPlaceholder>
    </IressCol>
  </IressRow>
...
<IressStack gap="spacing.4">
  <IressRow>
    <IressCol offset={{ xs: 0, md: 2, lg: 4 }}>
      <IressPlaceholder>
        <IressText textAlign="center">
          Column 1
          <br />
          {JSON.stringify({ xs: 0, md: 2, lg: 4 })}
        </IressText>
      </IressPlaceholder>
    </IressCol>
    <IressCol offset={{ xs: 0, md: 1, lg: 2 }}>
      <IressPlaceholder>
        <IressText textAlign="center">
          Column 2
          <br />
          {JSON.stringify({ xs: 0, md: 1, lg: 2 })}
        </IressText>
      </IressPlaceholder>
    </IressCol>
  </IressRow>
...
```tsx
import { IressCol, IressRow, IressContainer, IressPlaceholder } from '@iress-oss/ids-components';
