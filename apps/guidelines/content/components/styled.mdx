export const meta = {
  ...
  storybookUrl: 'https://main--691abcc79dfa560a36d0a74f.chromatic.com/?path=/docs/components_components-styled--docs',
};
...
```tsx
import { IressStack, IressStyled, IressText } from '@iress-oss/ids-components';
...
```tsx
import { IressIcon, IressStyled, IressText } from '@iress-oss/ids-components';
