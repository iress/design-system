...
```tsx
import { IressButton, IressInline, IressStack } from '@iress-oss/ids-components';
...
```tsx
import { IressButton, IressInline, IressText } from '@iress-oss/ids-components';
...
```tsx
import { IressButton, IressIcon, IressInline, IressPill, IressStack } from '@iress-oss/ids-components';
