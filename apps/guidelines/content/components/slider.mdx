import { sliderMeta } from '@iress-oss/ids-components/meta';
...
- [Field](/components/field) — wraps the slider with a label, hint, and error support
- [Input](/components/input) — for precise numeric entry
...
<IressButton mode="secondary" href="https://main--691abcc79dfa560a36d0a74f.chromatic.com/?path=/docs/components-slider--docs#api-props">View all props</IressButton>
...
<IressButton mode="secondary" href="https://main--691abcc79dfa560a36d0a74f.chromatic.com/?path=/docs/components-slider--docs#testing">View test IDs</IressButton>

---

### Storybook

<IressButton href="https://main--691abcc79dfa560a36d0a74f.chromatic.com/?path=/docs/components-slider--docs">View in Storybook</IressButton>
