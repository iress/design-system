...
```tsx
import { IressButton, IressInline, IressTooltip } from '@iress-oss/ids-components';
...
```tsx
import { IressButton, IressInline, IressStack, IressTooltip } from '@iress-oss/ids-components';
