export const meta = {
  ...
  description: 'This guide covers all breaking changes, deprecations, and new features introduced in version 6 of the Iress Design System. While the list is extensive, most changes relate to look-and-feel rather than code.',
  category: 'guide',
  storybookUrl: 'https://main--691abcc79dfa560a36d0a74f.chromatic.com/?path=/docs/components_resources-migration-guides-from-v5-to-v6--docs',
};
...
```tsx
import { IressSelect, IressSelectOption } from '@iress-oss/ids-components';
...
```tsx
import { IressAgGridContainer } from '@iress-oss/ids-components';
...
[View in Storybook →](https://main--691abcc79dfa560a36d0a74f.chromatic.com/?path=/docs/components_resources-migration-guides-from-v5-to-v6--docs)
