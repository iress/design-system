export const meta = {
  ...
  category: 'guide',
  storybookUrl: 'https://main--691abcc79dfa560a36d0a74f.chromatic.com/?path=/docs/components_resources-migration-guides-from-oui-to-v6--docs',
};
...
```tsx
import { IressButton, IressForm, IressFormField, IressInput, IressModal } from '@iress-oss/ids-components';
...
[View in Storybook →](https://main--691abcc79dfa560a36d0a74f.chromatic.com/?path=/docs/components_resources-migration-guides-from-oui-to-v6--docs)
