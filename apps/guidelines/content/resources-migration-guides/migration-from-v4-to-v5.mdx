export const meta = {
  ...
  description: 'This is a step-by-step guide for upgrading your application from IDS v4 to v5.',
  category: 'guide',
  storybookUrl: 'https://main--691abcc79dfa560a36d0a74f.chromatic.com/?path=/docs/components_resources-migration-guides-migration-from-v4-to-v5--docs',
};
...
// Before (v4 test utilities):
// const { findByTestId } = idsRender(<IressButton>Click</IressButton>);
// const button = await findByTestId('button');

// After (React Testing Library):
render(<IressButton>Click</IressButton>);
...
import '@iress/themes/dist/iress-theme-light.css';

<div className="ag-theme-alpine ag-theme-iress-lite iress-theme-light">
...
[View in Storybook →](https://main--691abcc79dfa560a36d0a74f.chromatic.com/?path=/docs/components_resources-migration-guides-migration-from-v4-to-v5--docs)
