...
```tsx
<IressCard px="sm" scrollable="y" style={{ maxHeight: 200 }}>
  <IressPanel>
    <h1>History of Iress</h1>

    <p>
      <strong>Iress Limited</strong> is an Australian-based software company
      that provides technology solutions to the financial services industry.
    </p>
