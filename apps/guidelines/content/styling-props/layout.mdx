...
<IressStack gap="md" horizontalAlign="center">
  ...
  <IressPanel bg="colour.primary.surface" alignSelf="start">
...
```tsx
import { IressCard, IressPanel } from '@iress-oss/ids-components';

<IressCard px="sm">
  <IressPanel scrollable="y" style={{ maxHeight: '300px' }}>
    ...
    <section>
      ...
      <p>
        ...
        trading software for financial institutions.
      </p>
    </section>
  </IressPanel>
</IressCard>
