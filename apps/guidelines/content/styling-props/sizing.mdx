export const meta = {
  title: 'Sizing',
  description: 'These are all styling props related to changing the size of a component,',
  category: 'guide',
  storybookUrl: 'https://main--691abcc79dfa560a36d0a74f.chromatic.com/?path=/docs/components_styling-props-sizing--docs',
};
...
<IressContainer bg="alt" fluid maxWidth="container.md" p="xl">
  This container is extra readable because its maxWidth is set to:{' '}
