...
```tsx
import { IressPanel, IressText } from '@iress-oss/ids-components';
...
[View in Storybook →](https://main--691abcc79dfa560a36d0a74f.chromatic.com/?path=/docs/components_styling-props-styling-props--docs)
