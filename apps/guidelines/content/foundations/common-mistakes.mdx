export const meta = {
  ...
  category: 'guide',
  storybookUrl: 'https://main--691abcc79dfa560a36d0a74f.chromatic.com/?path=/docs/components_foundations-common-mistakes--docs',
};
...
```tsx
import { IressIcon, IressInput } from '@iress-oss/ids-components';
...
```tsx
import { IressButton, IressIcon, IressShadow } from '@iress-oss/ids-components';
...
```tsx
import { IressButton, IressField, IressInput, IressText } from '@iress-oss/ids-components';
...
[View in Storybook →](https://main--691abcc79dfa560a36d0a74f.chromatic.com/?path=/docs/components_foundations-common-mistakes--docs)
