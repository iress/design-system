export const meta = {
  title: 'Accessibility',
  description: 'Accessibility is everyone\'s responsibility. It ensures that all users, regardless of their abilities or disabilities, can access and interact with our components effectively. This document outlines the key practices for building accessible components we follow within IDS.',
  category: 'guide',
  storybookUrl: 'https://main--691abcc79dfa560a36d0a74f.chromatic.com/?path=/docs/components_foundations-accessibility--docs',
};
...
[View in Storybook →](https://main--691abcc79dfa560a36d0a74f.chromatic.com/?path=/docs/components_foundations-accessibility--docs)
