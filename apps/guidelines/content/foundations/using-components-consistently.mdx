export const meta = {
  title: 'Using components consistently',
  description: 'Consistency guide documentation.',
  category: 'guide',
  storybookUrl: 'https://main--691abcc79dfa560a36d0a74f.chromatic.com/?path=/docs/components_foundations-using-components-consistently--docs',
};
...
[View in Storybook →](https://main--691abcc79dfa560a36d0a74f.chromatic.com/?path=/docs/components_foundations-using-components-consistently--docs)
