...
```tsx
import { IressStack, IressInline, IressText, IressDivider, IressPanel, IressContainer, IressRow, IressCol, IressPlaceholder } from '@iress-oss/ids-components';
...
<IressStack gap="lg">
  ...
  <IressText>
    <h2>Grid example</h2>
    <p>
      Do not use grids with more than 4 columns maximum on extra small
      screens. The minimum span on mobile devices is 3.
    </p>
  </IressText>
...
```tsx
import { IressStack, IressInline, IressText, IressDivider, IressContainer, IressRow, IressCol, IressPlaceholder } from '@iress-oss/ids-components';
...
<IressStack gap="lg">
  ...
  <IressText>
    <h2>Grid example</h2>
    <p>
      Do not use grids with more than 4 columns maximum on small screens.
      The minimum span on mobile devices is 3.
    </p>
  </IressText>
...
<IressStack gap="lg">
  ...
  <IressText>
    <h2>Grid example</h2>
    <p>
      Do not use grids with more than 6 columns maximum on medium screens.
      The minimum span on medium screens is 2.
    </p>
  </IressText>
  <IressContainer style={{ maxWidth: '740px' }}>
    <IressRow gutter="md">
...
<IressStack gap="lg">
  ...
  <IressText>
    ...
    <p>
      ...
      The minimum span on large screens is 1.
    </p>
  </IressText>
  <IressContainer style={{ maxWidth: '960px' }}>
    <IressRow gutter="md">
...
<IressStack gap="lg">
  ...
  <IressText>
    ...
    <p>
      From large screens onwards, all 12 columns of the grid can be used.
      The minimum span on extra large screens is 1. At this screen the
      container max width is applied, but can be opted out by using the
