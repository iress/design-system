export const meta = {
  title: 'Content & Iconography',
  description: 'Guidelines for writing clear interface text (microcopy) and using icons effectively across Iress products.',
};
...
<FigmaLink href="https://www.figma.com/design/youFqYT4CgpKxfLJQv80hf/WIP-Iress-Design-System-V6?node-id=6200-9" />
