...
export const NAV_ITEMS: SideNavItem[] = [
  ...
  },
  {
    ...
    element: Link,
    children: [
      { key: 'overview', label: 'Overview', href: '/components/overview', element: Link },
      ...
      { key: 'card', label: 'Card', href: '/components/card', element: Link },
  ...
  },
  {
    ...
    element: Link,
    children: [
      { key: 'overview', label: 'Overview', href: '/patterns/overview', element: Link },
  ...
  },
  {
    ...
    element: Link,
    children: [
      { key: 'overview', label: 'Overview', href: '/tokens/overview', element: Link },
