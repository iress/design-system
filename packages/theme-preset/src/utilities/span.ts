...
export const spanCompositions = {
  ...
  '3': {
    ...
    value: {
      ...
      maxWidth: 'calc(3 / 12 * 100%)',
      paddingInline: 'calc(var(--col-gap) / 2)',
    },
  },
  '4': {
    description: 'column spans 4/12 of the container width',
    value: {
      flexGrow: 0,
      flexShrink: 0,
  ...
  '5': {
    description: 'column spans 5/12 of the container width',
    value: {
      flexGrow: 0,
      flexShrink: 0,
  ...
  '6': {
    description: 'column spans 6/12 of the container width',
    value: {
      flexGrow: 0,
      flexShrink: 0,
      flexBasis: 'calc(6 / 12 * 100%)',
      maxWidth: 'calc(6 / 12 * 100%)',
      paddingInline: 'calc(var(--col-gap) / 2)',
    },
  },
  '7': {
    description: 'column spans 7/12 of the container width',
    value: {
      flexGrow: 0,
      flexShrink: 0,
  ...
  '8': {
    description: 'column spans 8/12 of the container width',
    value: {
      flexGrow: 0,
      flexShrink: 0,
  ...
  '9': {
    description: 'column spans 9/12 of the container width',
    value: {
      flexGrow: 0,
      flexShrink: 0,
      flexBasis: 'calc(9 / 12 * 100%)',
      maxWidth: 'calc(9 / 12 * 100%)',
      paddingInline: 'calc(var(--col-gap) / 2)',
    },
  },
  '10': {
    description: 'column spans 10/12 of the container width',
    value: {
      flexGrow: 0,
      flexShrink: 0,
      flexBasis: 'calc(10 / 12 * 100%)',
      maxWidth: 'calc(10 / 12 * 100%)',
      paddingInline: 'calc(var(--col-gap) / 2)',
    },
  },
  '11': {
    description: 'column spans 11/12 of the container width',
    value: {
      flexGrow: 0,
      flexShrink: 0,
      flexBasis: 'calc(11 / 12 * 100%)',
      maxWidth: 'calc(11 / 12 * 100%)',
      paddingInline: 'calc(var(--col-gap) / 2)',
    },
  },
  '12': {
    description: 'column spans 12/12 of the container width',
    value: {
      flexGrow: 0,
      flexShrink: 0,
      flexBasis: '100%',
