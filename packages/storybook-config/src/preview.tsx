...
import { IressStorybook } from './components/IressStorybook';
import { type FC } from 'react';
import { IressProvider } from '@iress-oss/ids-components';

interface PreviewProps {
  /**
   * Custom docs container to use instead of the default IressStorybook one.
   * This is used by certain packages that need to wrap the docs in their own provider.
   */
  docsContainer?: FC;
...
export const getPreview = ({ noProvider = false }: PreviewProps): Preview => ({
