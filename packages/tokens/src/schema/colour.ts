...
const colour = {
  ...
  neutral: {
    ...
    80: {
      $description:
        'Used as the default text colour for most components. For tooltips, it is used as the background colour. This token now uses the previous Neutral 90 value to improve visual hierarchy.',
      $type: Type.Color,
      $value: '#141F4D',
      $extensions: {
