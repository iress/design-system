...
component: "Link/Link.tsx"
propsType: "IressLinkProps"
---
...
[Open Loading in Storybook →](https://main--691abcc79dfa560a36d0a74f.chromatic.com/?path=/story/components-link--loading)
...
[Open Slots in Storybook →](https://main--691abcc79dfa560a36d0a74f.chromatic.com/?path=/story/components-link--slots)
...
[Open Element in Storybook →](https://main--691abcc79dfa560a36d0a74f.chromatic.com/?path=/story/components-link--element)

## Props

<auto-type-table path="../../../../../packages/components/src/components/Link/Link.tsx" name="IressLinkProps" />
