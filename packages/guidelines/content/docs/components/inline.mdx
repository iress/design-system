...
component: "Inline/Inline.tsx"
propsType: "IressInlineProps"
---
...
[Open Gap in Storybook →](https://main--691abcc79dfa560a36d0a74f.chromatic.com/?path=/story/components-inline--gap)

### Responsive gap

The `gap` prop can take an object that takes five key/value pairs that correlate with the IDS breakpoints.

[Open ResponsiveGap in Storybook →](https://main--691abcc79dfa560a36d0a74f.chromatic.com/?path=/story/components-inline--responsive-gap)
...
[Open HorizontalAlign in Storybook →](https://main--691abcc79dfa560a36d0a74f.chromatic.com/?path=/story/components-inline--horizontal-align)
...
[Open VerticalAlign in Storybook →](https://main--691abcc79dfa560a36d0a74f.chromatic.com/?path=/story/components-inline--vertical-align)
...
[Open NoWrap in Storybook →](https://main--691abcc79dfa560a36d0a74f.chromatic.com/?path=/story/components-inline--no-wrap)

## Props

<auto-type-table path="../../../../../packages/components/src/components/Inline/Inline.tsx" name="IressInlineProps" />
