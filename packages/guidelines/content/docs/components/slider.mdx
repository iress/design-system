...
component: "Slider/Slider.tsx"
propsType: "IressSliderProps"
---
...
[Open DefaultValue in Storybook →](https://main--691abcc79dfa560a36d0a74f.chromatic.com/?path=/story/components-slider--default-value)
...
[Open MinMaxAndStep in Storybook →](https://main--691abcc79dfa560a36d0a74f.chromatic.com/?path=/story/components-slider--min-max-and-step)
...
[Open TicksAndLabels in Storybook →](https://main--691abcc79dfa560a36d0a74f.chromatic.com/?path=/story/components-slider--ticks-and-labels)
...
[Open FlexibleTicksAndLabels in Storybook →](https://main--691abcc79dfa560a36d0a74f.chromatic.com/?path=/story/components-slider--flexible-ticks-and-labels)
...
[Open HiddenLabels in Storybook →](https://main--691abcc79dfa560a36d0a74f.chromatic.com/?path=/story/components-slider--hidden-labels)
...
[Open ReadOnly in Storybook →](https://main--691abcc79dfa560a36d0a74f.chromatic.com/?path=/story/components-slider--read-only)

## Props

<auto-type-table path="../../../../../packages/components/src/components/Slider/Slider.tsx" name="IressSliderProps" />
