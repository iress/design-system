...
The `IressIconProvider` component takes care of this for you when you use it with the `container` prop, which accepts a `HTMLElement | ShadowRoot` or `Ref<HTMLElement | ShadowRoot>`.

</details>

[Open IconProvider in Storybook →](https://main--691abcc79dfa560a36d0a74f.chromatic.com/?path=/story/components-provider--icon-provider)
...
[Open ScreenReaderText in Storybook →](https://main--691abcc79dfa560a36d0a74f.chromatic.com/?path=/story/components-icon--screen-reader-text)

### Filled

The `filled` prop allows you to use a filled version of the icon, usually to indicate an active state.

[Open Filled in Storybook →](https://main--691abcc79dfa560a36d0a74f.chromatic.com/?path=/story/components-icon--filled)
...
[Open Reference in Storybook →](https://main--691abcc79dfa560a36d0a74f.chromatic.com/?path=/story/components-icon--reference)
...
[Open Flip in Storybook →](https://main--691abcc79dfa560a36d0a74f.chromatic.com/?path=/story/components-icon--flip)

### Rotate

The `rotate` prop can be set to 90, 180 or 270 degrees.

[Open Rotate in Storybook →](https://main--691abcc79dfa560a36d0a74f.chromatic.com/?path=/story/components-icon--rotate)
...
[Open Spin in Storybook →](https://main--691abcc79dfa560a36d0a74f.chromatic.com/?path=/story/components-icon--spin)
...
[Open ExternalLink in Storybook →](https://main--691abcc79dfa560a36d0a74f.chromatic.com/?path=/story/components-icon--external-link)
...
[Open FontAwesomeToMaterialMigration in Storybook →](https://main--691abcc79dfa560a36d0a74f.chromatic.com/?path=/story/components-icon--font-awesome-to-material-migration)

## Props

<auto-type-table path="../../../../../packages/components/src/components/Icon/Icon.tsx" name="IressIconProps" />
