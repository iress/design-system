...
[Open SearchTable in Storybook →](https://main--691abcc79dfa560a36d0a74f.chromatic.com/?path=/story/patterns-dropdown-menu--search-table)
...
[Open Controlled in Storybook →](https://main--691abcc79dfa560a36d0a74f.chromatic.com/?path=/story/patterns-dropdown-menu--controlled)

### Multiple selection

Using the `multiSelect` prop, the `IressDropdownMenu` will allow the user to make multiple selections.

[Open MultiSelect in Storybook →](https://main--691abcc79dfa560a36d0a74f.chromatic.com/?path=/story/patterns-dropdown-menu--multi-select)
...
[Open Options in Storybook →](https://main--691abcc79dfa560a36d0a74f.chromatic.com/?path=/story/patterns-dropdown-menu--options)
...
[Open AsyncOptions in Storybook →](https://main--691abcc79dfa560a36d0a74f.chromatic.com/?path=/story/patterns-dropdown-menu--async-options)
...
[Open InitialOptions in Storybook →](https://main--691abcc79dfa560a36d0a74f.chromatic.com/?path=/story/patterns-dropdown-menu--initial-options)
...
[Open ComplexOptions in Storybook →](https://main--691abcc79dfa560a36d0a74f.chromatic.com/?path=/story/patterns-dropdown-menu--complex-options)
...
[Open InputProps in Storybook →](https://main--691abcc79dfa560a36d0a74f.chromatic.com/?path=/story/patterns-dropdown-menu--input-props)
...
[Open Searchable in Storybook →](https://main--691abcc79dfa560a36d0a74f.chromatic.com/?path=/story/patterns-dropdown-menu--searchable)
...
[Open ResetFilters in Storybook →](https://main--691abcc79dfa560a36d0a74f.chromatic.com/?path=/story/patterns-dropdown-menu--reset-filters)
...
[Open NoResultsText in Storybook →](https://main--691abcc79dfa560a36d0a74f.chromatic.com/?path=/story/patterns-dropdown-menu--no-results-text)
...
[Open PopoverProps in Storybook →](https://main--691abcc79dfa560a36d0a74f.chromatic.com/?path=/story/patterns-dropdown-menu--popover-props)
...
[Open SelectedOptionsText in Storybook →](https://main--691abcc79dfa560a36d0a74f.chromatic.com/?path=/story/patterns-dropdown-menu--selected-options-text)