...
<IressRow gutter="md">
  <IressCol span={6}>
    [Open Suspense in Storybook →](https://main--691abcc79dfa560a36d0a74f.chromatic.com/?path=/story/patterns-suspense--suspense)
  </IressCol>
  <IressCol span={6}>
    [Open FastSuspense in Storybook →](https://main--691abcc79dfa560a36d0a74f.chromatic.com/?path=/story/patterns-suspense--fast-suspense)
  </IressCol>
</IressRow>
```
...
<IressRow gutter="md">
  <IressCol span={6}>
    [Open Wizard in Storybook →](https://main--691abcc79dfa560a36d0a74f.chromatic.com/?path=/story/patterns---wizard)
  </IressCol>
  <IressCol span={6}>
    [Open FastWizard in Storybook →](https://main--691abcc79dfa560a36d0a74f.chromatic.com/?path=/story/patterns---fast-wizard)
  </IressCol>
</IressRow>
```