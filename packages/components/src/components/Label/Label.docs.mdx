...
<ComponentExample of={ComponentStories.OptionalText} meta={ComponentStories} />

### Disabled label

To indicate that an input is disabled, you may use the `disabled` prop to style the label accordingly.
