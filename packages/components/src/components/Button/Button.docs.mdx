...
<ComponentExample
  story={ComponentStories.ButtonsAsLinks}
  stories={ComponentStories}
/>
...
<ComponentExample
  story={ComponentStories.DeleteConfirmation}
  stories={ComponentStories}
/>
...
<ComponentExample
  story={ComponentStories.WrappingText}
  stories={ComponentStories}
/>
...
<ComponentExample story={ComponentStories.Attrs} stories={ComponentStories} />
...
<ComponentExample
  story={ComponentStories.DownloadButton}
  stories={ComponentStories}
/>
...
<ComponentExample
  ...
  story={CloseButtonStories.CloseButton}
  stories={CloseButtonStories}
/>
