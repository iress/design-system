...
<ComponentExample of={ComponentStories.AutoSized} />
...
<ComponentExample of={ComponentStories.Span} />
...
<ComponentExample of={ComponentStories.ResponsiveSpan} />

### Offset

The `offset` prop controls the amount of grid columns to offset.

<ComponentExample of={ComponentStories.Offset} />
...
<ComponentExample of={ComponentStories.ResponsiveOffset} />
