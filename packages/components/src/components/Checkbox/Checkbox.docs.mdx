...
<ComponentExample of={ComponentStories.Checked} meta={ComponentStories} />
...
<ComponentExample
  of={ComponentStories.DefaultChecked}
  meta={ComponentStories}
/>
...
<ComponentExample of={ComponentStories.Indeterminate} meta={ComponentStories} />
...
<ComponentExample of={ComponentStories.WithTableData} meta={ComponentStories} />
