...
<ComponentOverview
  description={
    <>
      The <code>IressStyled</code> component provides an unopinionated wrapper
      that gives you direct access to all supported styling properties. Use it
      when you need custom styling without creating a dedicated component or
      writing custom CSS.
    </>
  }
