...
import { ComponentExample, ComponentApi } from '@iress-storybook/components';
...
<IressAlert status="info" heading="Experimental" mb="md">
...
<ComponentExample
  story={AutocompleteRecipes.Table}
  stories={AutocompleteRecipes}
/>
