...
import { IressSelect, SelectRef, type IressSelectProps } from './Select';
...
import { type FormRef } from '@/patterns/Form';
...
describe('IressSelect', () => {
  ...
  it('renders a single select with the correct defaults', async () => {
    ...
    expect(select).toHaveClass(classes.root!);
  ...
  describe('interactions copied from native select', () => {
    it('returns focus to the activator when clicking the activator', async () => {
      render(<IressSelect options={MOCK_LABEL_VALUES} />);
  ...
  describe('props', () => {
    ...
    describe('multiSelect', () => {
      it('renders a multi-select with the correct defaults', async () => {
        ...
        expect(element).toHaveClass(classes.root!);
    ...
    it('should not have basic accessibility issues', async () => {
      const { container } = render(
        <>
          ...
          <IressSelect id="select" options={MOCK_LABEL_VALUES} />
        </>,
      );
  ...
  describe('ref methods', () => {
    it('exposes imperative handle methods', () => {
      const refObject = createRef<SelectRef>();
  ...
  describe('width', () => {
    it('applies correct width styling for fixed width variants', () => {
      ...
      widthVariants.forEach((width) => {
        ...
        const element = screen.getByTestId(`test-component-${width}`);
  ...
  describe('custom renderOptions onChange behavior', () => {
    ...
    it('triggers onChange callback in multiSelect mode with custom renderOptions', async () => {
      const onChange = vi.fn();
      const customRenderOptions: IressSelectProps<true>['renderOptions'] = ({
        results,
        handleMenuChange,
        value,
      }) => {
  ...
  describe('form submission', () => {
    ...
    it('resets native select value when form.reset() is called', async () => {
      interface TestFormData {
        provider: string;
      }

      const FormWithNativeSelectAndReset = () => {
      ...
      render(<FormWithNativeSelectAndReset />);
