...
<ComponentExample of={ComponentStories.OptionGroups} />
...
<ComponentExample of={ComponentStories.NonStringValues} />

### Placeholder

A default placeholder option can be set using the `placeholder` prop.

<ComponentExample of={ComponentStories.Placeholder} />
...
<ComponentExample of={ComponentStories.SelectedOption} />
