...
<ComponentOverview
  ...
  propsDetails={
    <p>
      ...
      <code>IressSelect</code>. In addition to these, you have access to the
      ...
      an <code>IressSelect</code> (eg. <code>className</code>,{' '}
      <code>onBlur</code>, etc) .
    </p>
  }
  of={ComponentStories.SingleSelect}
...
<ComponentExample of={ComponentStories.SingleSelect} />
...
<ComponentExample of={ComponentStories.PreSelectedValue} />
...
<ComponentExample of={ComponentStories.MultiSelectLimit} />
...
If you need to constrain or annotate the visible search field, use
`searchInputProps` to pass supported passive input props to the internal async
search input. This is useful for cases such as enforcing a maximum query length
without recreating the built-in search UI via `renderOptions`.

Supported `searchInputProps` keys are:
`className`, `data-testid`, `inputMode`, `maxLength`, `minLength`, `pattern`,
and `spellCheck`.

Do not use `searchInputProps` for interactive or controlled input behaviour
such as `value`, `onChange`, `placeholder`, `aria-label`, `disabled`,
`readOnly`, or refs. `IressSelect` keeps the async combobox query state,
placeholder text, and accessibility labelling under its own control. Only use
`renderOptions` when you need to replace the full built-in async options UI.

```tsx
<IressSelect
  options={searchOptions}
  searchInputProps={{ maxLength: 100 }}
/>
```
...
<ComponentExample of={ComponentStories.GroupedOptions} />
...
<ComponentExample of={ComponentStories.ErrorText} />
...
<ComponentExample of={ComponentStories.CustomLabel} />
...
<ComponentExample of={ComponentStories.CustomOptions} />
...
<ComponentExample of={ComponentStories.CreateNewOption} />
...
<ComponentExample of={ComponentStories.HeaderFooter} />
...
<ComponentExample of={ComponentStories.LongTextOptions} />
...
<ComponentExample of={ComponentStories.Native} />
...
<IressRow gutter="md">
  <IressCol>
    <ComponentExample of={LabelStories.NoneSelected} />
  </IressCol>
  <IressCol>
    <ComponentExample of={LabelStories.OneSelected} />
  </IressCol>
  <IressCol>
    <ComponentExample of={LabelStories.MultipleSelected} />
  </IressCol>
</IressRow>
...
<IressRow gutter="md">
  <IressCol>
    <ComponentExample of={MenuStories.Results} />
  </IressCol>
  <IressCol>
    <ComponentExample of={MenuStories.NoResults} />
  </IressCol>
</IressRow>
...
<IressRow gutter="md">
  <IressCol>
    <ComponentExample of={TagsStories.NoneSelected} />
  </IressCol>
  <IressCol>
    <ComponentExample of={TagsStories.Selected} />
  </IressCol>
</IressRow>
...
<ComponentExample of={TagsStories.LimitReached} />
...
<TestIdTable testIds={testIds} testIdPrefix="my-select" />
