...
<ComponentExample story={ComponentStories.Text} stories={ComponentStories} />
...
<ComponentExample story={ComponentStories.Rect} stories={ComponentStories} />
...
<ComponentExample story={ComponentStories.Circle} stories={ComponentStories} />
