...
<ComponentExample of={CardSlotsStories.Prepend} meta={CardStories} />
...
<ComponentExample of={CardSlotsStories.TopRight} meta={CardStories} />
...
<ComponentExample of={CardSlotsStories.Heading} meta={CardStories} />
...
<ComponentExample of={CardSlotsStories.Media} meta={CardStories} />
...
<ComponentExample of={CardSlotsStories.Content} meta={CardStories} />
...
<ComponentExample of={CardSlotsStories.Footer} meta={CardStories} />

### All slots

You can use all the slots together to create a custom card layout.

<ComponentExample of={CardSlotsStories.AllSlots} meta={CardStories} />
...
<ComponentExample
  of={CardClickableStories.HeadingOnly}
  meta={CardClickableStories}
/>
...
<ComponentExample
  of={CardClickableStories.WholeCard}
  meta={CardClickableStories}
/>
...
>
  <ComponentExample
    of={CardClickableStories.ButtonCard}
    meta={CardClickableStories}
  />
  <ComponentExample
    of={CardClickableStories.LinkCard}
    meta={CardClickableStories}
  />
</IressInline>
