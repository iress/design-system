...
<ComponentExample of={CardStories.Simple} />
...
<ComponentExample of={CardSlotsStories.Prepend} />
...
<ComponentExample of={CardSlotsStories.TopRight} />
...
<ComponentExample of={CardSlotsStories.Heading} />
...
<ComponentExample of={CardSlotsStories.Media} />
...
<ComponentExample of={CardSlotsStories.Content} />
...
<ComponentExample of={CardSlotsStories.Footer} />

### All slots

You can use all the slots together to create a custom card layout.

<ComponentExample of={CardSlotsStories.AllSlots} />
...
Clickable cards can use the `analytics` prop to generate a `data-analytics`
attribute for product instrumentation.

```tsx
<IressButtonCard analytics={{ page: 'portfolio', action: 'open-position' }}>
  Open position
</IressButtonCard>
```
...
<ComponentExample of={CardClickableStories.HeadingOnly} />
...
<ComponentExample of={CardClickableStories.WholeCard} />
...
<IressInline gap="md" horizontalAlign="around">
  <ComponentExample of={CardClickableStories.ButtonCard} />
  <ComponentExample of={CardClickableStories.LinkCard} />
</IressInline>
...
<TestIdTable testIds={testIds} testIdPrefix="my-card" />
