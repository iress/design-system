...
<ComponentOverview
  ...
  story={ComponentStories.AutomaticColumns}
...
<ComponentExample
  story={ComponentStories.CustomColumns}
  stories={ComponentStories}
/>
...
<ComponentExample story={ComponentStories.Formats} stories={ComponentStories} />
...
<ComponentExample story={ComponentStories.Sorting} stories={ComponentStories} />
...
<ComponentExample
  story={ComponentStories.CustomSortingLogic}
  stories={ComponentStories}
/>
...
<ComponentExample story={ComponentStories.Width} stories={ComponentStories} />
...
<ComponentExample
  story={ComponentStories.Alignment}
  stories={ComponentStories}
/>
...
<ComponentExample
  story={ComponentStories.Dividers}
  stories={ComponentStories}
/>
...
<ComponentExample
  story={ComponentStories.HighlightOnHover}
  stories={ComponentStories}
/>
...
<ComponentExample story={ComponentStories.Scope} stories={ComponentStories} />
...
<ComponentExample
  story={ComponentStories.HiddenHeader}
  stories={ComponentStories}
/>
...
<ComponentExample
  story={ComponentStories.RichRows}
  stories={ComponentStories}
/>
...
<ComponentExample
  story={ComponentStories.EmptyState}
  stories={ComponentStories}
/>
...
<ComponentExample story={ComponentStories.Static} stories={ComponentStories} />
...
<ComponentExample
  story={ComponentStories.RowProps}
  stories={ComponentStories}
/>
...
<ComponentExample
  ...
  story={TableBodyStories.Body}
  stories={TableBodyStories}
/>
...
<ComponentExample
  ...
  story={TableFormattedValueStories.FormattedValue}
  stories={TableFormattedValueStories}
/>
