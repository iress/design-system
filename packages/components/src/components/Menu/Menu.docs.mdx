...
<ComponentExample story={ComponentStories.Basic} stories={ComponentStories} />
...
<ComponentExample
  story={ComponentStories.SecondaryNavigation}
  stories={ComponentStories}
/>
...
<ComponentExample
  story={ComponentStories.Headings}
  stories={ComponentStories}
/>
...
<ComponentExample
  story={ComponentStories.SlotProps}
  stories={ComponentStories}
/>
...
<ComponentExample
  story={ComponentStories.ListRole}
  stories={ComponentStories}
/>
...
<ComponentExample
  story={ComponentStories.MenuRole}
  stories={ComponentStories}
/>
...
<ComponentExample
  story={ComponentStories.ListboxRole}
  stories={ComponentStories}
/>
...
<ComponentExample story={ComponentStories.NavRole} stories={ComponentStories} />
