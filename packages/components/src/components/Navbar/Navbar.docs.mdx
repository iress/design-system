...
<ComponentOverview
  description={
    <>
      The <code>IressNavbar</code> component defines your application’s global
...
<ComponentExample story={ComponentStories.Logos} stories={ComponentStories} />
...
<ComponentExample
  story={ComponentStories.Children}
  stories={ComponentStories}
/>
...
<ComponentExample story={ComponentStories.NavMenu} stories={ComponentStories} />

<ComponentExample
  story={ComponentStories.NavMenuAndChildren}
  stories={ComponentStories}
/>
...
<ComponentExample
  story={ComponentStories.Responsive}
  stories={ComponentStories}
/>
...
<ComponentExample story={ComponentStories.Icons} stories={ComponentStories} />
