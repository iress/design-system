...
<ComponentExample story={ComponentStories.GBP} stories={ComponentStories} />

Display the JPY with `locale="ja-JPY"` and `currencyCode="JPY"` props (must pass both together)

<ComponentExample story={ComponentStories.JPY} stories={ComponentStories} />
...
<ComponentExample
  story={ComponentStories.WithSymbol}
  stories={ComponentStories}
/>
