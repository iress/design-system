...
<ComponentExample story={AlertStories.Icon} stories={AlertStories} />
...
<ComponentExample story={AlertStories.Variant} stories={AlertStories} />
...
<ComponentExample story={AlertStories.Dismissable} stories={AlertStories} />
