...
<ComponentExample of={ComponentStories.FooterSlot} meta={ComponentStories} />
...
<IressAlert
  ...
  heading="Using with popovers and tooltips"
...
<ComponentExample of={ComponentStories.FixedFooter} meta={ComponentStories} />
...
<ComponentExample
  of={ComponentStories.ResponsiveSize}
  meta={ComponentStories}
/>
...
<ComponentExample
  of={ComponentStories.DisableClosing}
  meta={ComponentStories}
/>
