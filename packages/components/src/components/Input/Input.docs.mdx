...
<ComponentExample of={ComponentStories.FileType} />
...
You can also include interactive elements like buttons in the append slot. This is useful for search inputs or other scenarios where you want to trigger an action related to the input content.

<ComponentExample of={ComponentStories.ButtonSlots} />
...
<ComponentExample of={ComponentStories.CurrencyFormatter} />
...
<ComponentExample of={ComponentStories.AutoGrow} />
