...
import { IressAlert, IressButton } from '../../main';
...
<IressAlert status="info" heading="Microfrontends" mb="md">
...
<ComponentExample
  story={ComponentStories.ScreenReaderText}
  stories={ComponentStories}
/>
...
<ComponentExample story={ComponentStories.Flip} stories={ComponentStories} />

### Rotate

The `rotate` prop can be set to 90, 180 or 270 degrees.

<ComponentExample story={ComponentStories.Rotate} stories={ComponentStories} />
...
<ComponentExample story={ComponentStories.Spin} stories={ComponentStories} />
...
<ComponentExample
  story={ComponentStories.FixedWidth}
  stories={ComponentStories}
/>
...
<ComponentExample
  story={ComponentStories.ExternalLink}
  stories={ComponentStories}
/>
