...
The `verticalAlign` prop controls the vertical alignment of content within the stack. It accepts four values: `top`, `middle`, `bottom`, and `stretch`.

This is useful when you have a fixed height container and want to control how the content is positioned vertically.
