...
uses [DOMPurify](https://github.com/cure53/DOMPurify) to strip malicious HTML
from form values before submission.
...
<ComponentExample of={ComponentStories.SanitisingInput} />
