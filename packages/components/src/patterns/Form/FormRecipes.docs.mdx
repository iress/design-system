...
<ComponentExample
  story={ComponentStories.WithReadonlyData}
...
<ComponentExample
  story={ComponentStories.SwitchEditReadonly}
  stories={ComponentStories}
/>
...
<ComponentExample
  story={ComponentStories.NativeValidation}
  stories={ComponentStories}
/>
...
<ComponentExample
  story={ComponentStories.NestedForms}
  stories={ComponentStories}
/>
...
<ComponentExample
  story={ComponentStories.FormGroups}
  stories={ComponentStories}
/>
...
<ComponentExample
  story={ComponentStories.HiddenInputs}
  stories={ComponentStories}
/>
...
<ComponentExample
  story={ComponentStories.ValidationDependOnOtherFields}
  stories={ComponentStories}
/>
