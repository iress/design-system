...
<ComponentOverview
  ...
  of={ValidateStories.Validate}
  meta={ValidateStories}
/>
...
<IressRow gutter="md">
  <IressCol span={6}>
    <ComponentExample
      refresh
      of={SuspenseStories.Suspense}
      story={{
        inline: false,
        height: '600px',
      }}
      meta={SuspenseStories}
    />
  </IressCol>
  <IressCol span={6}>
    <ComponentExample
      refresh
      of={SuspenseStories.FastSuspense}
      story={{
        inline: false,
        height: '600px',
      }}
...
<IressAlert status="info" heading="Legacy polyfill">
