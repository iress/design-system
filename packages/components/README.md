# Iress Design System (IDS) - React component library

This is the component library for the Iress Design System (IDS). You can use this library to build React applications that align to IDS, and ensure a consistent and modern look and feel across all Iress products.
