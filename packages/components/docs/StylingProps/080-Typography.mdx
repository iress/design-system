...
<IressPanel textStyle="typography.body.lg">
  Panel content with large body text
</IressPanel>
...
- `typography.body.sm`, `typography.body.md`, `typography.body.lg` - Body text variants
...
<IressButton href="/?path=/docs/tokens_typography--docs" mt="md">
  View Full Typography Token Reference
</IressButton>
