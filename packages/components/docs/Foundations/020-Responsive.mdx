...
<IressPanel px="none">
  <Canvas of={ComponentStories.Breakpoints} />
</IressPanel>

### Extra-small screens (`xs`)

<Canvas of={ComponentStories.Xs} />

### Small screens (`sm`)

<Canvas of={ComponentStories.Sm} />

### Medium screens (`md`)

<Canvas of={ComponentStories.Md} />

### Large screens (`lg`)

<Canvas of={ComponentStories.Lg} />

### Extra-large screens (`xl`)

<Canvas of={ComponentStories.Xl} />

### Extremely large screens (`xxl`)

<Canvas of={ComponentStories.Xxl} />
...
<Canvas of={ComponentStories.ResponsiveProps} />
