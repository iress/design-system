...
import * as OUIStories from './oui.stories';
...
> **If you are migrating from IDS v5**, see [Migrating from v5](?path=/docs/resources-migration-guides-from-v5-to-v6--docs) instead — that guide focuses on v5-to-v6 breaking changes only.
...
<Story of={OUIStories.ButtonMigration} />
...
<Story of={OUIStories.ProgressBarMigration} />

Props are unchanged.

#### Badge → IressPill

<Story of={OUIStories.BadgeMigration} />
...
<Story of={OUIStories.ModalMigration} />
...
<Story of={OUIStories.DropdownMenuMigration} />

**IressSelect example (in a form):**

<Story of={OUIStories.DropdownSelectMigration} />
...
<Story of={OUIStories.ScrollableMigration} />
...
<Story of={OUIStories.FieldsetMigration} />

#### RadioGroup → IressFormField + IressRadioGroup

<Story of={OUIStories.RadioGroupMigration} />

#### Checkbox → IressFormField + IressCheckbox

<Story of={OUIStories.CheckboxMigration} />
...
> For a comprehensive list of all v5-to-v6 component changes, see [Migrating from v5](?path=/docs/resources-migration-guides-from-v5-to-v6--docs).
...
<Story of={OUIStories.RemoveTestUtils} />
...
<Story of={OUIStories.AccessibilityQueries} />

### Update Jest / Vitest configuration

<Story of={OUIStories.JestVitestConfig} />

### Form test migration

<Story of={OUIStories.FormTestMigration} />
